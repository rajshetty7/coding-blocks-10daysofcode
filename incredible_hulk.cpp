...
Explanation
Let total steps is n, find the nearest integer which is of power 2 and less then n. let it be k. 
...
//You can use the inbuilt function __builtin_popcount() for counting the set bits
...
int main() {
    ...
    for(int i=0;i<cases;i++) {
        cout<<minimum_moves(test[i])<<endl;
    }
